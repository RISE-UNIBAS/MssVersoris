...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                <div>
                    ...
                    <xsl:for-each select="//msDesc">
                        <div class="msDesc">
                            ...
                            <div class="history">
                                <span class="fieldname">History</span>
                                <xsl:apply-templates select="./history"/>
                            </div>
                            <div class="content">
                                <span class="fieldname">Content</span>
                                <ul>
                                    <xsl:apply-templates select="./msContents/msItem[not(@class)]"/>
                                </ul>
                            </div>
    ...
    <xsl:template match="msIdentifier">
        <xsl:text>: </xsl:text>
        <xsl:value-of select="./settlement"/>, <xsl:value-of select="./repository"/>, <xsl:if
            test="collection">
            <xsl:value-of select="./collection"/>, </xsl:if>
